...
},{"../react/components/tweetApp.react":151,"react":148}],2:[function(require,module,exports){
	...
	render: function(){
		...
		return (
			React.DOM.div({className: "notification"}, 
				...
				"Click ", React.DOM.a({onClick: this.showUnreadTweets}, " here "), " to see them;"
			)
		)
	}
});
...
},{"./notification.react":149,"./tweets.react":152,"react":148}],152:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
